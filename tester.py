...
Sends 100 concurrent requests to the /translate endpoint and counts which
container handled each request. Proves Docker Swarm's Ingress Mesh is
distributing traffic across all 4 replicas.
"""
...
TEST_PAYLOAD = {
    "text": "Hello, this is a Docker Swarm load balancing test.",
    "target_language": "FR",
    "source_language": "EN"
}
